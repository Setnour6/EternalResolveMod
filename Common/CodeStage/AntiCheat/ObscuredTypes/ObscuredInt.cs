...
namespace EternalResolve.Common.CodeStage.AntiCheat.ObscuredTypes
{
    [Serializable]
    public struct ObscuredInt : IEquatable<ObscuredInt>, IFormattable
    {
        ...
        private ObscuredInt( int PDGAOEAMDCL )
        {
            ...
            hiddenValue = PDGAOEAMDCL;
            inited = true;
        }

        public static void SetNewCryptoKey( int DCCMJMPNCDO ) => cryptoKey = DCCMJMPNCDO;
