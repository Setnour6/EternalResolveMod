...
{
    public class PrayButton_2 : Control
    {
        ...
        {
            spriteBatch.Draw( PrayAssets.Button[ 2 ] , DrawPosition , null , Color , 0f , Size / 2 , Scale , SpriteEffects.None , 1f );
