...
{
    public class PrayButton_0 : Control
    {
        ...
        {
            spriteBatch.Draw( PrayAssets.Button[ 0 ] , DrawPosition , null , Color , 0f , Size / 2 , Scale , SpriteEffects.None , 1f );
