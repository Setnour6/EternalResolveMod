...
{
    public class PrayClose : Control
    {
        ...
        {
            if ( new Rectangle( PositionX.ToInt( ) + 16 , PositionY.ToInt( ) + 16 , 64 , 64 ).IntersectMouse( ) )
                Interactive = true;
            else
                Interactive = false;
        }
        ...
        {
            spriteBatch.Draw( PrayAssets.Close , DrawPosition , null , Color , 0f , Size / 2 , Scale , SpriteEffects.None , 1f );
