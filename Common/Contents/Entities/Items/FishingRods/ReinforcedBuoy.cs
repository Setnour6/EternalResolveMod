...
{
    public class ReinforcedBuoy : ModProjectile
    {
        ...
        public override bool PreDrawExtras( )
        {
            ...
            if ( Projectile.bobber && Main.player[ Projectile.owner ].inventory[ Main.player[ Projectile.owner ].selectedItem ].holdStyle > 0 )
            {
                ...
                if ( type == ModContent.ItemType<ReinforcedWoodenFishingRod>( ) )
                {
                    num += ( 50 * Main.player[ Projectile.owner ].direction );
                ...
                float num3 = Projectile.position.X + Projectile.width * 0.5f - vector.X;
                float num4 = Projectile.position.Y + Projectile.height * 0.5f - vector.Y;
                ...
                else
                {
                    ...
                    vector.X -= num3;
                    vector.Y -= num4;
                    num3 = Projectile.position.X + Projectile.width * 0.5f - vector.X;
                    num4 = Projectile.position.Y + Projectile.height * 0.5f - vector.Y;
                }
                while ( flag )
                {
                    float num6 = 12f;
                    ...
                    else
                    {
                        ...
                        vector.Y += num4;
                        num3 = Projectile.position.X + Projectile.width * 0.5f - vector.X;
                        num4 = Projectile.position.Y + Projectile.height * 0.1f - vector.Y;
                        if ( num8 > 12f )
                        {
                            float num9 = 0.3f;
