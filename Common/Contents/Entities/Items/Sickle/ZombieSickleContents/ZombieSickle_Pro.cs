...
{
    public class ZombieSickle_Pro_Frame : GlobalProjectile
    {
    ...
    public class ZombieSickle_Pro : ERProjectile
    {
        ...
        public override bool PreAI( )
        {
            ...
            ZombieSickle_Pro_Frame ProjectileFrame = Projectile.GetGlobalProjectile<ZombieSickle_Pro_Frame>( );
