...
{
    public class WoodenSlashChopFrame : GlobalProjectile
    {
    ...
    public class WoodenSlashChop : ERProjectile
    {
        ...
        public override bool PreAI( )
        {
            ...
            WoodenSlashChopFrame ProjectileFrame = Projectile.GetGlobalProjectile<WoodenSlashChopFrame>( );
