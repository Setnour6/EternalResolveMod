...
namespace EternalResolve.Common.Contents.Entities.Items.Slashs.NightKillerSlashs
{
    ...
    public class NightKillerSlashChop : ERProjectile
    {
        ...
        public override bool PreAI( )
        {
            ...
            NightKillerSlashChopFrame ProjectileFrame = Projectile.GetGlobalProjectile<NightKillerSlashChopFrame>( );
        ...
        {
            if ( target.TypeName.Contains( "蝙蝠" ) || target.TypeName.Contains( "bat" ) || target.TypeName.Contains( "Bat" ) )
            {
                knockback *= 1.1f;
                crit = true;
            }
