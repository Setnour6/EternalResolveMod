...
{
    public class OriginChopFrame : GlobalProjectile
    {
    ...
    public class OriginSlashChop : ERProjectile
    {
        ...
        public override bool PreAI( )
        {
            ...
            OriginChopFrame ProjectileFrame = Projectile.GetGlobalProjectile<OriginChopFrame>( );
