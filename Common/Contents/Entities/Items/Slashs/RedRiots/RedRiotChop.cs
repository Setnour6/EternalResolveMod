...
{
    public class RedRiotChopFrame : GlobalProjectile
    {
    ...
    public class RedRiotChop : ERProjectile
    {
        ...
        public override bool PreAI( )
        {
            ...
            RedRiotChopFrame ProjectileFrame = Projectile.GetGlobalProjectile<RedRiotChopFrame>( );
        ...
        {
            Player player = Main.player[ Projectile.owner ];
            Projectile.NewProjectile( Projectile.InheritSource(Projectile) , Projectile.position , Vector2.UnitX * player.direction , ModContent.ProjectileType<RedRiotPower>( ) , player.HeldItem.damage , 0 , player.whoAmI , 0 , 0 );
            base.Kill( timeLeft );
        }
    }
}
