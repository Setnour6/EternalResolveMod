...
namespace EternalResolve.Common.Contents.Entities.Items.Slashs.RedRiots
{
    ...
    public class RedRiotChop : ERProjectile
    {
        ...
        {
            Player player = Main.player[ Projectile.owner ];
            Projectile.NewProjectile( new ERProjectileSource( ) , Projectile.position , Vector2.UnitX * player.direction , ModContent.ProjectileType<RedRiotPower>( ) , player.HeldItem.damage , 0 , player.whoAmI , 0 , 0 );
            base.Kill( timeLeft );
        }
    }
}
