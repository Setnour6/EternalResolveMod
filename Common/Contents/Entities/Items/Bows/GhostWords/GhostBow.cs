    ...
    public class GhostBow : ERProjectile
    {
        ...
        public override void AI( )
        {
            ...
            if ( Projectile.frame == 17 )
            {
                ...
                Projectile.NewProjectile( new ERProjectileSource( ) , player.Center , Projectile.velocity * 30f , ModContent.ProjectileType<GhostArrow>( ) , Projectile.damage , Projectile.knockBack , Main.myPlayer , 0f , 0f );
            }
